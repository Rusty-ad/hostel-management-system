	...
	<body>
		...
		<form action="login-confirm.php" method="POST" id="admin-form">
			...
			<div class="container" id="logCont">
				...
				<input type="text" placeholder="Enter Username" name="username" id="uname" value="<?php if(isset($_COOKIE["username"])) {echo $_COOKIE["username"]; } ?>" required>

				<label><b>Password</b></label>
				<input type="password" placeholder="Enter Password" name="password" id="psw" value="<?php if(isset($_COOKIE["password"])) {echo $_COOKIE["password"]; } ?>" required>
						
				<input type="checkbox" name="remember"> Remember me
				<button type="submit" class="admin-button" name="login" value="Login">Login</button>
			</div>

			<div class="container" style="background-color:#f1f1f1">
				<button type="button" class="admin-button" id="cancelbtn"><a href="index.php">Cancel</a></button>
